...
class TvUsbDebuggingActivity extends TvBottomSheetActivity implements View.OnClickListener {
    private static final String TAG = TvUsbDebuggingActivity.class.getSimpleName();

    private UsbDisconnectedReceiver mDisconnectedReceiver;
    private final BroadcastDispatcher mBroadcastDispatcher;

    private CheckBox mAlwaysAllowCheckbox;
    ...
    protected void onResume() {
        ...
        LinearLayout alwaysAllowLayout = findViewById(R.id.always_allow_layout);

        mAlwaysAllowCheckbox = findViewById(R.id.always_allow);

        String title = getString(com.android.systemui.res.R.string
                .usb_debugging_title);
        String content = getString(com.android.systemui.res.R.string
                .usb_debugging_message, mFingerprints);
        String allwaysTitle = getString(com.android.systemui.res.R.string
                .usb_debugging_always);
        titleTextView.setText(title);
        contentTextView.setText(content);

        alwaysAllowLayout.setVisibility(View.VISIBLE);
        mAlwaysAllowCheckbox.setText(allwaysTitle);
    ...
    public void onClick(View v) {
        boolean allow = (v.getId() == R.id.bottom_sheet_positive_button);
        notifyService(allow);
        finish();
    }

    private void notifyService(boolean allow) {
        boolean alwaysAllow = allow && mAlwaysAllowCheckbox.isChecked();
